...
public partial class TradeHistory : ContentPage
{
	...
	public TradeHistory()
	{
		...
		tableAUD.Transactions.Add(new TradeHistoryRowViewModel(){ Date = DateTime.Today, Price=-31, Balance = -10, Description = "Concordant Crossroad" });
		tableAUD.Transactions.Add(new TradeHistoryRowViewModel(){ Date = DateTime.Today, Price=21, Balance = 21, Description = "Sensei's Top" });
		...
		tableUSD.Transactions.Add(new TradeHistoryRowViewModel(){ Date = DateTime.Today, Price=-31, Balance = -10, Description = "Concordant Crossroad" });
		tableUSD.Transactions.Add(new TradeHistoryRowViewModel(){ Date = DateTime.Today, Price=21, Balance = 21, Description = "Sensei's Top" });
